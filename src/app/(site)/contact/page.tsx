...
const NEXT_STEPS = [
  ...
  "We call or email to confirm specifications and timing.",
  "You receive a written quote and digital proof to review.",
];
          ...
          <div className="rounded-xl border border-line bg-card p-7 shadow-xs">
            ...
            <div className="mt-5 flex flex-col gap-4 border-t border-line pt-5 text-[14px]">
              ...
              <div>
                ...
                <p className="mt-0.5 text-ink-muted">{STUDIO.city}, United Kingdom</p>
              </div>
            </div>
          </div>
